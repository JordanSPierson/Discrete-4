...
(check-expect (min-<< 'z 'b) 'b)
(check-expect (min-<< 'c 'a) 'a)
(check-expect (min-<< 'l 'm) 'l)
...
(check-expect (tree-max '(a 1 nil (b 3 (a 2 nil nil) nil))) 'b)
(check-expect (tree-max '(x 1 nil (t 3 (y 2 nil nil) nil))) 'y)
(check-expect (tree-max '(x 1 nil (e 3 (d 2 nil nil) nil))) 'x)
(check-expect (tree-max '(l 2 nil (b 5 (h 2 4 nil) 9))) 'l)
...
(check-expect (tree-min '(x 1 nil (a 3 (y 2 nil nil) nil))) 'a)
(check-expect (tree-min '(x 1 nil (z 3 (f 2 nil nil) nil))) 'f)
(check-expect (tree-min '(x 1 nil (z 3 (y 2 (c 4 nil nil) nil) nil))) 'c)
(check-expect (tree-min '(p 1 nil (z 3 (y 2 nil nil) nil))) 'p)
(check-expect (tree-min '(x 1 nil (z 3 (y 2 (c 4 nil (a 90 nil nil)) nil) nil))) 'a)
...
(defun search-treep (tree)
   (if (consp tree)
       (if (and (equal tree 4) 
                () ;valid symbol check
                () ;value is rational number check
                () ;left tree is nil or the max of the left tree is <<the key
                () ;the right tree is nil or the key is << the min of the right
                () ;the left tree is a valid search tree
                () ;the right tree is a valid search tree
            );;; 2.1 through 2.7
       t   ;;; 1.
       )))
